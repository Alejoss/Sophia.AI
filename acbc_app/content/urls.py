...
from .views import (
    ...
    FeaturedTextWithThumbnailsView,
...
urlpatterns = [
    ...
    path(
        'featured-text-thumbnails/',
        FeaturedTextWithThumbnailsView.as_view(),
        name='featured-text-thumbnails',
    ),
    ...
    path('admin/topics/', AdminTopicsConversationView.as_view(), name='admin-topics-conversation'),
    ...
    path(
        ...
        name='topic-chat-queries',
    ),
    path(
        'topics/<int:pk>/chat/queries/<int:query_id>/',
        TopicChatQueryDetailView.as_view(),
        name='topic-chat-query-detail',
    ),

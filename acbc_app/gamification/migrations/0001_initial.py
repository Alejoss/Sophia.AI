    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['code'], name='gamificatio_code_edd252_idx'), models.Index(fields=['is_active'], name='gamificatio_is_acti_972de6_idx')],
            },
        ),
        migrations.CreateModel(
            name='UserBadge',
            ...
            options={
                'ordering': ['-earned_at'],
                'indexes': [models.Index(fields=['user', 'badge'], name='gamificatio_user_id_2146ba_idx'), models.Index(fields=['earned_at'], name='gamificatio_earned__4b40a8_idx')],

        ...
        badges_data = [
            {
                ...
                'description': 'Marca el inicio formal del viaje de aprendizaje del usuario',
            ...
            },
            {
                ...
                'description': 'Representa comprensión precisa y completa de conceptos',
                'category': BadgeCategory.LEARNING,
                'points_value': 25,
            },
            {
                ...
                'description': 'Recompensa la consistencia y el aprendizaje sostenido en el tiempo',
                'category': BadgeCategory.LEARNING,
                'points_value': 35,
            },
            {
            ...
            },
            {
                ...
                'description': 'Reconoce la capacidad de estructurar y organizar conocimiento para otros',
                'category': BadgeCategory.CONTRIBUTION,
                'points_value': 60,
            },
            {
                ...
                'name': 'Autor Validado',
                'description': 'Señala creación consistente con validación de la comunidad',
                'category': BadgeCategory.CONTRIBUTION,
                'points_value': 50,
            },
            {
                ...
                'description': 'Recompensa claridad, rigor y utilidad en el discurso',
            ...
            },
            {
                ...
                'description': 'Reconoce contenido que se vuelve significativo para la comunidad',
                'category': BadgeCategory.RECOGNITION,
                'points_value': 40,
            },
            {
                ...
                'name': 'Voz Confiable',
                'description': 'Representa confianza sostenida ganada a través de contribuciones de alta calidad repetidas',
                'category': BadgeCategory.RECOGNITION,
                'points_value': 45,
            },
            {
            ...
            },
            {
                ...
                'description': 'Reconoce la creación de un tema que alcanza amplio reconocimiento comunitario, demostrando capacidad para estructurar conocimiento de manera significativa',
                'category': BadgeCategory.RECOGNITION,
                'points_value': 65,
            },
        ]
